    ...
    <div ng-controller="MinesweeperController">
        ...
        <table id="AngularMineSweeper" class="minefield">
            <tr ng-repeat="row in minefield.rows">
                <td ng-repeat="spot in row.spots" ng-init="imgsrc='http://luis-perez.s3-us-west-2.amazonaws.com/angularjs-minesweeper-game/covered.png'" 
                    ng-mouseover="imgsrc='Pictures/3077-24x24x8.png'" ng-mouseout="imgsrc='http://luis-perez.s3-us-west-2.amazonaws.com/angularjs-minesweeper-game/covered.png'" ng-click="uncoverSpot(spot)">
                    <img ng-if="spot.isCovered" src="{{imgsrc}}" />
